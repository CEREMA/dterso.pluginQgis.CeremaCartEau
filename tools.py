...
def setStyleShadowQLabel(qLabel):
    ...
    effectShadow = QtGui.QGraphicsDropShadowEffect()
    effectShadow.setBlurRadius(10)                         # defaut: 1
    effectShadow.setColor(QtGui.QColor(100,100,100, 180))  #defaut: QtGui.QColor(63, 63, 63, 180)
...
def getThemeIcon(theName):
    ...
    myQrcPath = "python" + os.sep + "plugins" + os.sep + "CeremaCartEau" + os.sep + theName;
